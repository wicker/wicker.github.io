...
I dislike Wordpress because I didn't entirely understand how it worked but it never inspired me enough to find out. I'm admittedly not entirely sure how Jekyll works but implementing it makes me feel like I have more control -- and whenever I want to find out how it works, I'm able to be right in there up to my elbows. There's a hacker or geek factor with Jekyll that's probably just mostly marketing but I like the idea of static sites in general. 

Why not webgen or nanoc or Hyde? Only because Jekyll got to me first ... and because it was on Github. The big thing everybody around me is switching to for version control is git.

<div style="padding: 0px; margin: 0px; margin-bottom: 10px; float:left; display:inline; color: #0000C3; background: #000;">My first site went up in 1997. It was an Earth: Final Conflict fan site, I think, and I was twelve so it looked a lot like this. I hand-coded all my pages in the Geocities HTML box. </div> 

Nevertheless, I miss it -- and by extension I miss static sites.
...
My own config and layout files are available at <a href="http://wicker.github.com/compendiarious.net">my Github account</a>. 
