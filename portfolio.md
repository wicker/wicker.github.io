...
<div class="container">
  ...
  <div id="myBtnContainer" class="two columns">
    <button class="btn projbtn active" onclick="filterSelection('summary')">Summary</button>
    <button class="btn projbtn" onclick="filterSelection('education')">Education</button>
    <br />
    <button class="btn projbtn" onclick="filterSelection('web')">Websites</button>
    <button class="btn projbtn subbtn" onclick="filterSelection('flask')">Flask</button>
    <button class="btn projbtn subbtn" onclick="filterSelection('react')">React</button>
    <button class="btn projbtn subbtn" onclick="filterSelection('wordpress')">Wordpress</button>
    <button class="btn projbtn" onclick="filterSelection('hardware')">Hardware</button>
    <button class="btn projbtn" onclick="filterSelection('software')">Software</button>
    <button class="btn projbtn" onclick="filterSelection('talks')">Talks</button>
  </div>
  ...
  <div class="seven columns padded">
    ...
    <div class="project education">
      ...
      <p><strong>React Nanodegree</strong><br />Udacity, 2018</p>
    ...
    <h4 class="project web">Web Sites and Apps</h4>
    <h4 class="project react">React Sites</h4>
    ...
    <div class="projthumb project web js react">
      <a href="https://github.com/wicker/" target="_blank">
        ...
        Rider-Waite Tarot Reader App</a>
    </div>
    ...
    <h4 class="project flask">Flask Sites</h4>
    <div class="projthumb project web flask">
      <a href="https://github.com/wicker/Wallowa-Wildlife-Checklist-App" target="_blank">
        ...
        Wallowa Wildlife Checklist
      </a>
    </div>
    <h4 class="project wordpress">Wordpress Sites</h4>
    ...
    <h4 class="project">Static and Jekyll Sites</h4>
    ...
    <h4 class="project">Documentation</h4>
    <div class="projthumb project web">
    ...
    <h4 class="project">Javascript</h4>
    ...
    <h4 class="project hardware">Hardware Projects</h4>

    <div class="projthumb project hardware">
    ...
    <div class="projthumb project hardware arduino">
      <a href="http://wickerbox.net/img/thumbs/ovenboard3.png" target="_blank">
        <img src="/img/thumbs/ovencontrol.png">
        Reflow Oven Controller
      </a>
    </div>
    <h4 class="project talks">Conference Talks</h4>
    ...
    <h4 class="project software">Software Projects</h4>
    ...
    <div class="projthumb project software python">
      <a href="http://kifisher.io/" target="_blank">
        <img src="/img/thumbs/kifisher.png">
        KiCad Project Management Tools
      </a>
    </div>
